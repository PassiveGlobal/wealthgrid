  ...
  return (
    <div className="relative mt-8">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="bg-[#1E2537]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#2A3040] hover:border-secondary transition-all group hover:transform hover:scale-[1.02] duration-300 animate-float" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="bg-[#1E2537]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#2A3040] hover:border-secondary transition-all group hover:transform hover:scale-[1.02] duration-300 animate-float" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="bg-[#1E2537]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#2A3040] hover:border-secondary transition-all group hover:transform hover:scale-[1.02] duration-300 animate-float" style={{ animationDelay: "0.3s" }}>
